...
(function() {
  ...
  // School-match confirmation ("✓ Matched — School, City, ST") is rendered by
  // the shared school_autocomplete.js itself (its .school-autocomplete-match
  // line), so this form doesn't wire its own listener for it.
