class SecurityLog < ActiveRecord::Base
  ...
  enum event_type: [
    ...
    :password_reset_blocked, :user_updated, :contact_info_created, :contact_info_deleted,
    :contact_info_confirmed, :contact_info_confirmation_resent, :contact_info_confirmation_failed,
    :contact_info_confirmation_blocked, :authentication_created, :authentication_transferred,
    :authentication_deleted, :application_created, :application_updated, :application_deleted,
    :admin_created, :admin_deleted, :user_updated_by_admin, :user_deleted_by_admin,
    :users_searched_by_admin, :contact_info_verified_by_admin, :admin_became_user
  ]
