class SecurityLog < ApplicationRecord
  ...
  # Values are persisted as integers; never renumber or reuse one, only append new entries.
  enum event_type: {
    unknown: 0,
    ...
    user_contact_id_updated_from_salesforce: 100,
    attempted_to_add_school_not_cached_yet: 101,
    school_added_to_user_from_sheerid_webhook: 102,
    user_lead_id_updated_from_salesforce: 103,
    salesforce_lead_not_found_by_id: 104,
    salesforce_lead_found_by_uuid: 105,
    salesforce_lead_found_by_email: 106,
    user_already_has_contact_not_creating_lead: 107,
    creating_new_salesforce_lead: 108,
    salesforce_lead_save_failed: 109,
    reset_password_unverified_email: 110,
    recaptcha_verified: 111,
    recaptcha_blocked: 112,
    salesforce_lead_already_converted: 113,
    updated_salesforce_contact: 114,
    salesforce_contact_save_failed: 115,
