...
Rails.application.routes.draw do
  ...
  scope controller: 'newflow/instructor_signup' do
    # Step 1
    get 'signup/educator', action: :instructor_signup_form, as: :instructor_signup
    post 'signup/educator', action: :instructor_signup, as: :instructor_signup_post
    ...
    get 'signup/educator/cs_form', action: :instructor_profile_form, as: :educator_cs_verification_form
