...
ActiveRecord::Schema.define(version: 2026_09_21_180000) do
  ...
  create_table "users", id: :serial, force: :cascade do |t|
    ...
    t.datetime "salesforce_last_seen_pushed_at"
    ...
    t.index ["salesforce_last_seen_pushed_at", "last_seen_at"], name: "index_users_linked_students_by_last_seen", where: "((role = 1) AND (salesforce_student_id IS NOT NULL))"
    t.index ["salesforce_last_seen_pushed_at", "last_seen_at"], name: "index_users_with_contact_by_last_seen", where: "(salesforce_contact_id IS NOT NULL)"
