namespace :accounts do
  desc 'Create leads for faculty users that started signup but did not finish '\
       'so they can be reviewed by customer service'
  # Run task with the optional days of leads you want uploaded
  #  eg. `rake accounts:create_leads_for_abandoned_user_signups[1]`
