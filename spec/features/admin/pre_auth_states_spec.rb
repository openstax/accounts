  ...
  context 'as an admin user' do
    ...
    it "works" do
      Timecop.freeze(4.weeks.ago) do
        FactoryBot.create contact_info_value: "a@a.com"
      end
      Timecop.freeze(1.9.weeks.ago) do
        FactoryBot.create contact_info_value: "b@b.com"
      end
      Timecop.freeze(0.9.weeks.ago) do
        FactoryBot.create contact_info_value: "c@c.com"
      end
      FactoryBot.create contact_info_value: "d@d.com"
