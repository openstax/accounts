RSpec.shared_examples 'adding and resetting password from profile' do |parameter|
  ...
  scenario 'successful' do
    ...
    # The sign-out is a full-page navigation, which Capybara's click does not
    # wait for -- visiting login_path first would still be authenticated and
    # bounce to the profile.
