...
feature 'User manages emails', js: true do
  ...
  context 'create' do
    ...
    scenario 'success' do
      click_link(t :"legacy.users.edit.add_email_address")
      ...
      expect(page).to have_button(t :"legacy.users.edit.resend_confirmation")
    ...
    scenario 'click to verify does not change token' do
      ...
      within all(".email-entry").last do
        find(".unconfirmed-warning").click
        expect(page).to have_button(t :"legacy.users.edit.resend_confirmation")
        click_button(t :"legacy.users.edit.resend_confirmation")
      end
  ...
  context 'resend_confirmation' do
    ...
    scenario 'success' do
      ...
      expect(page).to have_button((t :"legacy.users.edit.resend_confirmation"), disabled: true)
    end
  end
