...
xfeature 'Login inside an iframe', js: true do
  ...
  scenario 'a user signs in' do
    ...
    page.driver.within_frame 'content' do
      ...
      expect(page).to have_content(t :"legacy.sessions.start.sign_in_with_facebook")
      fill_in (t :"legacy.sessions.start.username_or_email"), with: 'user'
      fill_in (t :"legacy.sessions.start.password"), with: 'password'
      click_button (t :"legacy.sessions.start.sign_in")
