...
RSpec.describe Admin::ExportUsers, type: :routine do
  ...
  before(:all) do
    ...
    @user_2 = FactoryGirl.create :user, first_name: 'Mary',
                                        last_name: 'Mighty',
                                        username: 'mary'
    @user_3 = FactoryGirl.create :user, first_name: 'John',
                                        last_name: 'Stead',
                                        username: 'jstead'

    @identity_1 = FactoryGirl.create :identity, user: @user_1
    @authentication_1 = FactoryGirl.create :authentication, user: @user_1,
                                                            provider: 'identity',
                                                            uid: @identity_1.id

    @identity_2 = FactoryGirl.create :identity, user: @user_2
    @authentication_2 = FactoryGirl.create :authentication, user: @user_2,
                                                            provider: 'identity',
                                                            uid: @identity_2.id
