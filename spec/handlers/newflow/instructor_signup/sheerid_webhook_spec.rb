...
#RSpec.describe Newflow::InstructorSignup::SheeridWebhook, type: :routine, vcr: VCR_OPTS do
RSpec.describe Newflow::InstructorSignup::SheeridWebhook, type: :routine do
