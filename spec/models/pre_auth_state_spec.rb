...
RSpec.describe PreAuthState, type: :model do
  ...
  it 'strips contact info value' do
    ss = PreAuthState.new(contact_info_value: " yo@yo.com\r")
    ss.valid?
    expect(ss.contact_info_value).to eq "yo@yo.com"
  end

  it 'initializes tokens on create' do
    ss = PreAuthState.email_address.new(contact_info_value: "j@j.com", role: "faculty")
